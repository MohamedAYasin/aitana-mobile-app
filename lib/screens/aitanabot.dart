...
class _AitanaBotScreenState extends State<AitanaBotScreen> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        _messages.add(_ChatMessage(
          text: "Hi there! I'm AITANABOT 🤖. Ask me anything about e-waste, sustainability, or climate change!",
          isUser: false,
        ));
      });
    });
  ...
  void _sendMessage() async {
    ...
    try {
      ...
      setState(() {
        _messages.add(_ChatMessage(
          text: data['response'] ?? "⚠️ No response from AITANABOT.",
          isUser: false,
        ));
      });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    const userBubble = Color(0xFFD6E6FF); // light blue
    const botBubble = Color(0xFFF1F5F9); // soft gray
    const inputFill = Color(0xFFE3F2FD); // soft blue
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Row(
                    ...
                    children: [
                      if (!msg.isUser)
                        CircleAvatar(radius: 16, backgroundImage: avatar as ImageProvider),
